...
export const NewsletterFooter: React.FC<NewsletterFooterProps> = ({ onNotify, onOpenLegal }) => {
  ...
  return (
    <footer id="club" className="relative bg-[#FAF7F2] text-[#15191E] pt-4 sm:pt-8 pb-16 overflow-hidden select-none">
      
      {/* Background Ambient Glow */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-40 left-1/2 -translate-x-1/2 w-[700px] h-[500px] rounded-full bg-[#4A7C59]/10 blur-[140px]"
      />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        {/* 4 Brand Pillars */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-10 border-y border-[#EAE3D8] mb-16 text-center">
          {[
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-[#EAE3D8] text-xs text-[#15191E]/60">
          <div className="flex flex-wrap items-center justify-center gap-6 font-mono font-semibold uppercase tracking-wider">
            <button onClick={() => onOpenLegal('privacy')} className="hover:text-[#15191E] transition-colors">
              Privacy Policy
            </button>
            <button onClick={() => onOpenLegal('terms')} className="hover:text-[#15191E] transition-colors">
              Terms of Service
            </button>
            <button onClick={() => onOpenLegal('shipping')} className="hover:text-[#15191E] transition-colors">
              Shipping Rates
            </button>
            <button onClick={() => onOpenLegal('returns')} className="hover:text-[#15191E] transition-colors">
              Returns & Refunds
            </button>
            <button onClick={() => onOpenLegal('admin')} className="text-[#15191E]/30 hover:text-[#15191E] transition-colors">
              Admin Portal
            </button>
          </div>

          <div className="text-[#15191E]/50 font-mono text-center md:text-right">
